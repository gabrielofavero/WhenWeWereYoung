/* ======= Passeios HTML JS =======
 Funções relacionadas a página HTML Passeios */
...
function _loadP() {
  ...
  var TYPE_TITLE =  _getFromPlacesJSON(TYPE, PLACES_JSON, "title");
  var DISPLAY_TITLE = _getFromPlacesJSON(TYPE, PLACES_JSON, "displayTitle");
  var TYPE_SUBTITLE = _getFromPlacesJSON(TYPE, PLACES_JSON, "subtitle");
  ...
  if (PLACE) {
    ...
    if (AUTO_SORT_BY_SCORE) { // Ordena por Nota (Desc) e Nome (Asc)
